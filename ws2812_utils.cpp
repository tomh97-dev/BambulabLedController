...
void setws2812Color(int redValue, int greenValue, int blueValue, int coldValue, int warmValue) { //Function to change ledstrip color
    if (redValue == startR && greenValue == startG && blueValue == startB && coldValue == startC && warmValue == startW) {
        return;
    }
   transitionws2812Color(redValue,greenValue,blueValue,coldValue,warmValue,100);
}
